# Traceroute
## Project Description
A program that parses a network trace dump generated by traceroute. The program analyzes a textual tcpdump trace of traffic generated during Traceroute operations. It extracts information such as each router's address on the path to the destination and the time taken to send and receive data to each router by analyzing ICMP messages.
